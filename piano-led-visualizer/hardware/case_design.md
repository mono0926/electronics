...
> [!NOTE]
> **独自アレンジについて**
> [公式リポジトリ（`onlaj`版）](https://github.com/mono0926/Piano-LED-Visualizer/tree/ja)で標準提供されているケース（[`RPICaseModel.stl`](https://github.com/mono0926/Piano-LED-Visualizer/blob/ja/Docs/RPICaseModel.stl)）は「案A（スタッキング）」専用の極小サイズです。本プロジェクトでは基板の長寿命化と安全性を目指し、独自の「案B（横並び）」構成を標準としているため、ケースも公式のものではなく独自の設計を前提としています。
