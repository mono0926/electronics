...
> [!NOTE]
> **独自アレンジについて**
> ベースとなる [`onlaj/Piano-LED-Visualizer` リポジトリ](https://github.com/mono0926/Piano-LED-Visualizer/tree/ja)では「案A（スタッキング）」が標準とされていますが、本ドキュメント群では、日本国内での部品調達のしやすさと、高負荷時の熱対策・安定性を重視し、**「案B（横並び）」を本プロジェクト独自の推奨構成として提案**しています。
