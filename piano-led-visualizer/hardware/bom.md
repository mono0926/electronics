...
| **ユニバーサル基板(大)** | 片面 72×95mm 等                  | 案B: 横並び構成用。詳細は [assembly_options.md](assembly_options.md)       | [Amazon](https://www.amazon.co.jp/dp/B01MTW8IKU) / [秋月 (100518)](https://akizukidenshi.com/catalog/g/g100518/)        |
| **ピンヘッダ 1×40**      | 2.54mmピッチ                     | 案Bで Pi を基板に接続する際に使用 (カットして利用)                         | [秋月 (100167)](https://akizukidenshi.com/catalog/g/g100167/)                                                           |
| **アルミフラットバー**   | **2mm厚 × 20mm幅 × 305mm (6本)** | 放熱・固定用。305mm×4本で88鍵幅(≒1,220mm)をカバー。                        | [Amazon (uxcell)](https://amzn.to/4kZIVV1)                                                                              |
