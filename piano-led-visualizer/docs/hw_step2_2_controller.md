...
| :--- | :---: | :--- | :--- | :--- |
| **5V** | **2** | **左列・一番下** (※) | **下段・一番左** | 電源 (5V) |
| **GND** | **6** | **左列・下3番目** | **下段・左3番目** | グランド |
| **3.3V** | **1** | **右列・一番下** | **上段・一番左** | 電源 (3.3V) |
| **RST** | **13** | **右列・下7番目** | **上段・左7番目** | リセット |
| **BL** | **18** | **左列・下9番目** | **下段・左9番目** | バックライト |
| **DIN** | **19** | **右列・下10番目** | **上段・左10番目** | SPIデータ |
| **DC** | **22** | **左列・下11番目** | **下段・左11番目** | 制御 |
| **CLK** | **23** | **右列・下12番目** | **上段・左12番目** | SPIクロック |
| **CS** | **24** | **左列・下12番目** | **下段・左12番目** | チップセレクト |
